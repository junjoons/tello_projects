...
def main():
    ...
    while True:
        ...
        cv2.resize(img, (cap_width, cap_height))
        ...
        if results.multi_hand_landmarks is not None:
            ...
            for index in range(len(results.multi_handedness)):
                ...
                which_hand.append(results.multi_handedness[index].classification[0].label)
                # print(which_hand)
            # print(len(results.multi_handedness))

            '''
            if which_hand == ['Right']: hand_status = which_hand
            elif which_hand == ['Left'] : hand_status = which_hand
            ...
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                one_hand_gesture = keypoint_classifier_labels[hand_sign_id]
